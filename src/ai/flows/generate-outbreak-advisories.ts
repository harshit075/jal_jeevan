...
const GenerateOutbreakAdvisoryOutputSchema = z.object({
  ...
  riskLevel: z.enum(['High', 'Medium', 'Low']).describe('The assessed risk level of the situation. High for outbreaks, Medium for warnings, Low for general advice.')
});
...
const prompt = ai.definePrompt({
  ...
  - Assess the risk level. Use 'High' for confirmed outbreaks or severe immediate threats. Use 'Medium' for clear warnings or potential outbreaks. Use 'Low' for general health advice or minor issues.

  Ensure the advisory is clear, actionable, and easy to understand.

  Output the advisory in the specified JSON format.
  `,
});
