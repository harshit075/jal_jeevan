        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-8">
          <div className="flex items-center gap-4">
             <div className="flex flex-col items-center text-center">
                <Image src="/images/logo-health-ministry.svg" alt="Ministry of Health and Family Welfare Logo" width={40} height={40} className="h-12 w-auto"/>
                <p className="text-xs text-muted-foreground mt-2 max-w-40">Ministry of Health and Family Welfare</p>
             </div>
             <div className="flex flex-col items-center text-center">
                <Image src="/images/logo-jal-shakti.svg" alt="Ministry of Jal Shakti Logo" width={40} height={40} className="h-12 w-auto"/>
